#ifndef __FFCY_VL53L0_I2C_H
#define __FFCY_VL53L0_I2C_H
...
#define VL_SDA_IN()  {GPIOC->MODER&=~(3<<(3*2));GPIOC->MODER|=0<<3*2;}	//PC3输入模式
#define VL_SDA_OUT() {GPIOC->MODER&=~(3<<(3*2));GPIOC->MODER|=1<<3*2;}	//PC3输出模式

//#define VL_SDA_IN()  {GPIOA->CRL&=0XFFFFFF0F;GPIOA->CRL|=0x00000080;}
//#define VL_SDA_OUT() {GPIOA->CRL&=0XFFFFFF0F;GPIOA->CRL|=0x00000030;}


//IO操作函数	 
#define VL_IIC_SCL    PCout(2) 		  //SCL
#define VL_IIC_SDA    PCout(3) 		    //SDA	 
#define VL_READ_SDA   PCin(3) 		    //输入SDA 
//#define VL_IIC_SDA    PAout(1) 		    //SDA	 
//#define VL_READ_SDA   PAin(1) 		    //输入SDA 
...
extern  VL53LX VL53Lx_Data;

u8 VL53LX_init(void);
void VL53LX_Statemachine(void);
