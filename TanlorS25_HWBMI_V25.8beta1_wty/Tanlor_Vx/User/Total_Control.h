...
*               All rights reserved
----------------------------------------------------------------------------------------------------------------------*/
#ifndef _TOTAL_CONTROL_
#define _TOTAL_CONTROL_
...
extern float UWB_X, UWB_Y, UWB_Z;
extern u8 UWB_Position[10];
extern u8 Targ_UWB_Flag;
extern float UWB_X_Filter, UWB_Y_Filter;
extern u16 UWB_X_Filter_Pre, UWB_Y_Filter_Pre;
extern u16 Position_CND;
