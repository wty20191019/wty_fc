...
{ 
	switch (Cmd)
	{
		...
		case SET_LINE_CODING:
			...
			//打印配置参数
			//UART4_printf("系统运行中...\n");
			//UART4_printf("linecoding.format:%d\r\n",linecoding.format);
			//UART4_printf("linecoding.paritytype:%d\r\n",linecoding.paritytype);
			//UART4_printf("linecoding.datatype:%d\r\n",linecoding.datatype);
			//UART4_printf("linecoding.bitrate:%d\r\n",linecoding.bitrate);
			break; 
		...
		case SET_CONTROL_LINE_STATE:
			//UART4_printf("SET_CONTROL_LINE_STATE..\n");
			break;   
		case SEND_BREAK:
			//UART4_printf("SEND_BREAK..\n");
			break;   
		default:break;  
	} 
	return USBD_OK;
