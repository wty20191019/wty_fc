...
//#include "copyright.h"        //测试时注释掉  //正式使用时打开（应该要开）
//#include "arm_math.h"
//#include "HW_Config.h"
//#include "Queue.h"
//#include "ringbuf.h"          //测试时注释掉  //正式使用时打开（应该要开）

//#include "usbd_cdc_core.h"    //测试时注释掉  //正式使用时打开（应该要开）
//#include "usbd_usr.h"         //测试时注释掉  //正式使用时打开（应该要开）
//#include "usb_conf.h"         //测试时注释掉  //正式使用时打开（应该要开）
//#include "usbd_desc.h"        //测试时注释掉  //正式使用时打开（应该要开）
//#include "usbd_cdc_vcp.h"     //测试时注释掉  //正式使用时打开（应该要开）
//#include "usb_dcd_int.h"      //测试时注释掉  //正式使用时打开（应该要开）
